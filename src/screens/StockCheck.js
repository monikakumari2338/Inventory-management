...
const StockCheck = ({route}) => {
  ...
  const navigateToScreen = () => {
    ...
    //   product =>
    //     product.color === selectedColor && product.size === selectedSize,
    // );\

    navigation.navigate('StoreData', {
  ...
  // const [selectedColor, setSelectedColor] = useState(match.color);

  // const [selectedSize, setSelectedSize] = useState(match.size);
  // const [selectedproduct, setselectedProduct] = useState(match);
        ...
        <View style={{flex: 1}}>
          ...
          <ScrollView>
            <View style={[styles.iphone14ProMax1]}>
              ...
              <Text
                style={[styles.viewAvailableStock]}
